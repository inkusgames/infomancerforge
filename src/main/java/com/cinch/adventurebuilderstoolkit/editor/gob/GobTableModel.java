...
public class GobTableModel extends AbstractTableModel {
	...
	public boolean isCellEditable(int rowIndex, int columnIndex) {
		if (gob.getType()==com.cinch.adventurebuilderstoolkit.beans.gobs.GOB.Type.Base && (columnIndex!=0 && columnIndex!=4 && gob.getPropertyDefinitions().get(rowIndex).getType()==Type.ID)) {
			return false;
		}
		return true;
	}
