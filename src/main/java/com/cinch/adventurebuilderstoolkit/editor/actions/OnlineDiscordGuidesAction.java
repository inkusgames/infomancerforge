...
public class OnlineDiscordGuidesAction extends AbstractAction {
	static private final Logger log = LogManager.getLogger(OnlineDiscordGuidesAction.class);
	...
	public OnlineDiscordGuidesAction() {
		putValue(NAME, "Discord Guides");
	...
	public void actionPerformed(ActionEvent e) {
		if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
		    try {
				Desktop.getDesktop().browse(new URI("https://discord.com/channels/977481865562841178/1105848939887992925"));
			} catch (Exception e1) {
