...
public class OnlineDiscordAction extends AbstractAction {
	static private final Logger log = LogManager.getLogger(OnlineDiscordAction.class);
	...
	public OnlineDiscordAction() {
		putValue(NAME, "Our Discord");
	...
	public void actionPerformed(ActionEvent e) {
		if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
		    try {
				Desktop.getDesktop().browse(new URI("https://discord.com/invite/WZFzFM6P"));
			} catch (Exception e1) {
